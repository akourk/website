...
const positions: Position[] = [
  {
    ...
    description: 'Modernizing customer-facing insurance policy tools as part of State Farm’s broader digital transformation efforts.',
    points: [
      'Build and own customer-facing policy management flows using TypeScript, React, and Redux, supporting 40,000 monthly users.',
      'Design frontend components and patterns that are shared across teams, making features easier to extend and maintain over time.',
      'Modernize the legacy COBOL mainframe by incrementally replacing with Java/Spring and Python services, contributing to a 70%+ reduction in operational costs.',
      'Leading planning and rollout of AI-driven capabilities, including integrating AI into existing workflows, defining success metrics, and tracking progress against concrete milestones.',
      'Improve existing UI flows by simplifying navigation, clarifying user intent, and giving customers more direct control over policy changes.',
      'Work closely with product, design, and backend partners to scope work, validate requirements, and ship changes safely in a regulated environment.',
      'Improve accessibility across customer flows to meet WCAG standards and create a more inclusive experience.',
    ],
  },
  {
    company: 'Microsoft',
