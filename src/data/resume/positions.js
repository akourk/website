const positions = [
  {
    ...
    points: [
      'Performed false-positive/false-negatives analysis, summarizing findings and equipping architects with the essential information to tune detection algorithms.',
      'Aggregated discoveries from detailed analysis of services abuse into enhancements backlog, providing the requirements needed to incrementally improve the product.',
      ...
      'Prepared and maintained comprehensive onboarding programming and responsible for training all new hires.',
    ],
  },
  {
    company: 'WattTime',
